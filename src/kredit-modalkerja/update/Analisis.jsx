...
const hasSlikRowData = (rowMap) =>
  rowMap && Object.values(rowMap).some((value) => String(value ?? "").trim());
...
const computeTotalLabaKonsumtif = (
  ...
  return formatTwoDecimals(
    totalPendapatan - toNumber(biayaNonOperasional)
  );
};
...
export default function UpdateAnalisis() {
...
const handleSave = async () => {
  ...
  try {
    ...
    Swal.fire("Berhasil", "Data Analisis Kredit berhasil diperbaharui", "success");
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="1">{"Kurang dari 1 Tahun"}
                        </option>
                      </Select>
